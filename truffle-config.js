...
const infuraKey = "e9bb6bcb07d747769f44c26774893333";

const fs = require('fs');
const testnetMnemonic = fs.readFileSync(".testnet_secret").toString().trim();
const mainnetMnemonic = fs.readFileSync(".mainnet_secret").toString().trim();
