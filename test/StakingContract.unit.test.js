...
contract('StakingContract | Unit Tests', function ([owner, rewardsAddress, unauthorized, account1, account2]) {
    ...
    describe('constructor', async function () {
        ...
        it('should set the right rewardsAddress', async function () {
    ...
    describe('Function: setupStakingLimit', async function () {
        ...
        it('should allow to setup staking periods until the setup is finalized (rewards are setup)', async function () {
            const newConfig = {
    ...
    describe('Function: setupRewards', async function () {
        ...
        it('should set the status to Running when the staking is configured', async function () {
    ...
    describe('Function: deposit', async function () {
        ...
        it('should revert if deposit is called with an amount of 0', async function () {
